...
void DownloadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->taskUpdated((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->taskRemoved((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->allTasksChanged(); break;
        ...
        case 7: _t->onUpdateSpeed(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DownloadManager::*)(int )>(_a, &DownloadManager::taskAdded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DownloadManager::*)(int )>(_a, &DownloadManager::taskUpdated, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (DownloadManager::*)(int )>(_a, &DownloadManager::taskRemoved, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (DownloadManager::*)()>(_a, &DownloadManager::allTasksChanged, 3))
            return;
    }
}
...
// SIGNAL 0
void DownloadManager::taskAdded(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void DownloadManager::taskUpdated(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void DownloadManager::taskRemoved(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void DownloadManager::allTasksChanged()
{
