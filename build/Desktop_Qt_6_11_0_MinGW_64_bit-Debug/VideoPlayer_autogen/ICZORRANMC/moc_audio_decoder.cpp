/****************************************************************************
** Meta object code from reading C++ file 'audio_decoder.h'
**
...
#error "The header file 'audio_decoder.h' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject AudioDecoder::staticMetaObject = { {
    QMetaObject::SuperData::link<AudioDecoderBase::staticMetaObject>(),
...
void *AudioDecoder::qt_metacast(const char *_clname)
{
    ...
    return AudioDecoderBase::qt_metacast(_clname);
}

int AudioDecoder::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = AudioDecoderBase::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
