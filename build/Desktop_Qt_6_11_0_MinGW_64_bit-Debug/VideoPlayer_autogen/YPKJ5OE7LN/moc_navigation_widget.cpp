...
void NavigationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->playerClicked(); break;
        case 1: _t->downloadClicked(); break;
        case 2: _t->themeClicked(); break;
        case 3: _t->settingsClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NavigationWidget::*)()>(_a, &NavigationWidget::playerClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NavigationWidget::*)()>(_a, &NavigationWidget::downloadClicked, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (NavigationWidget::*)()>(_a, &NavigationWidget::themeClicked, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (NavigationWidget::*)()>(_a, &NavigationWidget::settingsClicked, 3))
            return;
    }
}
...
// SIGNAL 0
void NavigationWidget::playerClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void NavigationWidget::downloadClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void NavigationWidget::themeClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void NavigationWidget::settingsClicked()
{
