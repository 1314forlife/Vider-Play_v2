...
void ProgressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sigSeekRequested((*reinterpret_cast<std::add_pointer_t<int64_t>>(_a[1]))); break;
        ...
        case 6: _t->onUpdateTimeLabel(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ProgressBar::*)(int64_t )>(_a, &ProgressBar::sigSeekRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ProgressBar::*)()>(_a, &ProgressBar::sliderPressed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ProgressBar::*)()>(_a, &ProgressBar::sliderReleased, 2))
            return;
    }
}
...
// SIGNAL 0
void ProgressBar::sigSeekRequested(int64_t _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ProgressBar::sliderPressed()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void ProgressBar::sliderReleased()
{
